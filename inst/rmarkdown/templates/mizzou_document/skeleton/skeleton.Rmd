...
information of interest, the analysis of which is then featured in the 
[results](#results) section. Finally, the [discussion](#discussion) section 
concludes with limitations and broader implications.

## Setup

All data wrangling and analysis was done in the R environment with the help of 
the [ggplot2](https://ggplot2.tidyverse.org) and 
